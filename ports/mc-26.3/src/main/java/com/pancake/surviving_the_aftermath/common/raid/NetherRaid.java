...
public class NetherRaid extends BaseRaid {
    ...
    public void setMobSpawn(ServerLevel level, Mob mob) {
        ...
        if (mob instanceof Slime slime) {
            slime.finalizeSpawn(level, level.getCurrentDifficultyAt(slime.blockPosition()), EntitySpawnReason.EVENT, null);
        }
    ...
    protected void updateStructure() {
        ...
        if (start != StructureStart.INVALID_START) {
            Optional<StructureTemplate> template = this.level.getStructureTemplateManager().get(NetherRaidStructure.STRUCTURE_TRANSFORMED);
