...
public class RegistryUtil {
    ...
    public static EntityType<?> getEntityTypeFromRegistryName(String registryName) {
        EntityType<?> entityType = net.minecraft.core.registries.BuiltInRegistries.ENTITY_TYPE.get(ResourceLocation.tryParse(registryName));
        if (entityType == null) {
    ...
    public static Block getBlockFromRegistryName(String registryName) {
        Block block = net.minecraft.core.registries.BuiltInRegistries.BLOCK.get(ResourceLocation.tryParse(registryName));
        if (block == null) {
    ...
    public static Item getItemFromRegistryName(String registryName) {
        Item item = net.minecraft.core.registries.BuiltInRegistries.ITEM.get(ResourceLocation.tryParse(registryName));
        if (item == null) {
