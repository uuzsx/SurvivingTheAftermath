...
public class EquipmentPredicate implements IPredicateModule {
    ...
    public void apply(LivingEntity livingEntity) {
        if (livingEntity instanceof Mob mob){
            ...
            equipment.getWeightedList().getRandom(livingEntity.getRandom())
                    .ifPresent(item -> mob.equipItemIfPossible((net.minecraft.server.level.ServerLevel) mob.level(), item.getDefaultInstance()));
        }
    }
