...
public class ModStructurePieceTypes {
	...
	public static final DeferredRegister<StructurePieceType> STRUCTURE_PIECE_TYPES = DeferredRegister.create(Registries.STRUCTURE_PIECE.identifier(), SurvivingTheAftermath.MOD_ID);
