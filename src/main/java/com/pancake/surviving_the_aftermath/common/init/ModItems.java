...
public final class ModItems {
    ...
    public static final java.util.function.Supplier<Item> NETHER_CORE = ITEMS.register("nether_core", () -> new Item(properties("nether_core")));
