...
public class ClientForgeEvent {
    ...
    public static void netherRaidProgress(CustomizeGuiOverlayEvent.BossEventProgress event) {
        ...
        if (aftermath != null) {
            ...
            //渲染进度条框
            graphics.blit(net.minecraft.client.renderer.RenderType::guiTextured, resource, (graphics.guiWidth() - frameWidth) / 2, frameY,
                    0, frameOffset, frameWidth, frameHeight, 256, 256);
            //渲染进度条
            graphics.blit(net.minecraft.client.renderer.RenderType::guiTextured, resource, (graphics.guiWidth() - barWidth) / 2, frameY + barOffset,
