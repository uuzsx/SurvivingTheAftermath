...
public final class CityVegetationData extends SavedData {
    ...
    public static CityVegetationData get(ServerLevel level) {
        return level.getDataStorage().computeIfAbsent(new SavedData.Factory<>(CityVegetationData::new, (tag, provider) -> load(tag), null), KEY);
    }
    ...
    @Override public CompoundTag save(CompoundTag tag, net.minecraft.core.HolderLookup.Provider provider) { return write(tag); }
}
