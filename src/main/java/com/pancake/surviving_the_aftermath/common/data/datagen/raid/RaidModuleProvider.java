...
public class RaidModuleProvider extends AftermathModuleProviders<BaseRaidModule> {
    ...
    private BaseRaidModule create(RaidDifficulty difficulty, int[][] counts, int rewardTime, ItemWeightedModule rewards) {
        List<EntityType<?>> types = List.of(net.minecraft.world.entity.EntityTypes.PIGLIN, net.minecraft.world.entity.EntityTypes.PIGLIN_BRUTE, net.minecraft.world.entity.EntityTypes.HOGLIN,
                net.minecraft.world.entity.EntityTypes.MAGMA_CUBE, net.minecraft.world.entity.EntityTypes.BLAZE, net.minecraft.world.entity.EntityTypes.GHAST);
