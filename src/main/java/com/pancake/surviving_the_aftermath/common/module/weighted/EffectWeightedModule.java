...
public class EffectWeightedModule extends BaseWeightedModule<MobEffectInstance> {
    ...
    public static class Builder {
        ...
        public Builder add(String effect, int duration, int amplifier, int weight){
            effects.add(WeightedEntry.wrap(new MobEffectInstance(net.minecraft.core.registries.BuiltInRegistries.MOB_EFFECT.getHolder(ResourceLocation.parse(effect)).orElseThrow(), duration, amplifier), weight));
            return this;
        }
