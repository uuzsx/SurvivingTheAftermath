...
public interface IAftermathModule extends IModule<IAftermathModule> {
    Supplier<Codec<IAftermathModule>> CODEC = () -> ModuleRegistry.AFTERMATH_MODULE_REGISTRY.byNameCodec()
            .dispatch("aftermath_module", IAftermathModule::type, value -> com.pancake.surviving_the_aftermath.common.util.CodecUtils.mapCodec(value.codec()));
