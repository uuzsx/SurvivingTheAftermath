...
public final class ContentGameTests {
    ...
    public static void cowardicePricesAndLegacyTrades(GameTestHelper h) throws Exception {
        ...
        for(String profession:List.of("farmer","butcher")) {
            ...
            seller.setVillagerData(seller.getVillagerData().setProfession(BuiltInRegistries.VILLAGER_PROFESSION.getValue(net.minecraft.resources.ResourceLocation.withDefaultNamespace(profession))).setLevel(4));
